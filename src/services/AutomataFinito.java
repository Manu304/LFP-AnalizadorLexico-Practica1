...
public interface AutomataFinito {
    ...
    /**
     * Método para obtener el valor númerico que representa el caracter dentro del
     * alfabeto
     *
     * @param c El caracter del que se quiere saber su valor dentro del automata.
    ...
    /**
     * Método para obtener los mensajes generados por el autómata durante el proceso
     * de validacion de tokens.
     *
